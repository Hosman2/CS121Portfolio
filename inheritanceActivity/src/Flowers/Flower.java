...
//----------------------------------- OBJECT BEHAVIORS (METHODS)
    ...
    public String wiltflower(){
        return name + " flowers are wilting";
    }
//ToString method
...
// is intended to override a method with the same signature in a superclass or interface.
    ...
    public String toString() {
        return String.format("The Flowers.Flower: %s Color: %s # of petals: %d Height: %.2f", name, color, numOfPetals, height);
    }
